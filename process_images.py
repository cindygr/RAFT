...
if __name__ == '__main__':
    ...
    parser.add_argument('--start_index', default=220, help="start index")
    parser.add_argument('--end_index', default=220+ 60, help="end index")
    parser.add_argument('--skip_index', default=5, help="skip")
